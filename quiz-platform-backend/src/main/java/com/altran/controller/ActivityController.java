...
import com.altran.service.ActivityService;
...
public class ActivityController {
	 ...
	 * 
	 * @param activityRepository the service of activity
	 */
	@Autowired
	 ...
	 */
	@GetMapping(value = "/{id}")
	public ResponseEntity<Object> getActivityById(@PathVariable(value = "id") Long id) {
		try {
	 ...
	 */
	@PostMapping
	public ResponseEntity<GenericResponse<String>> createActivity(@RequestBody @Valid Activity activity) {
		try {
	 ...
	 */
	@PutMapping(value = "/{id}")
	public ResponseEntity<GenericResponse<String>> updateActivity(@RequestBody @Valid Activity activity,
