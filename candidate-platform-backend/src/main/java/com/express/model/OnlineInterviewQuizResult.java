...
public class OnlineInterviewQuizResult implements Serializable {
	...
	@JoinColumn(name = "online_interview_id", nullable = true, foreignKey = @ForeignKey(name = "FK_ONLINEINTERVIEW"))
	 ...
	 */
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "quiz_id", nullable = true, foreignKey = @ForeignKey(name = "FK_QUIZ"))
	@MapsId("quizId")
	private Quiz quiz;
	...
	/**
	 * The list of passed questions of this OnlineInterviewQuizResult.
	 * 
	 * @see PassedQuestion
	 */
