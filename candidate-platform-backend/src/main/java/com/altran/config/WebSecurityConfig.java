...
import com.altran.config.JwtAuthenticationEntryPoint;
import com.altran.config.JwtAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private UserDetailsService candidateDetailsService;
	...
	public void globalUserDetails(AuthenticationManagerBuilder auth) throws Exception {
		auth.userDetailsService(candidateDetailsService).passwordEncoder(encoder());
	}
