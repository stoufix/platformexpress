...
public class Ajout_prenom_caracteres_speciaux_echec {
	...
	@Test
	public void insertFirstNameSpecialCharacters() throws InterruptedException {
		...
		// Insert special characters in the form field firstName
		driver.findElement(By.id("firstName-add")).sendKeys("_Ghassen");
		// Wait
		Thread.sleep(1000);
		// Write last name
