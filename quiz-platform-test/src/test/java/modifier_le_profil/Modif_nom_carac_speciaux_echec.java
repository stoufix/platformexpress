...
public class Modif_nom_carac_speciaux_echec {
	...
	public void updateConnectedUserLastName() throws InterruptedException {
		...
		/********* Update User lastName with a special character *********/
		// Clear lastName field
		driver.findElement(By.id("lastName")).clear();
		// Wait
		Thread.sleep(1000);
		// Insert a lastName that contain a special character in the first position
		driver.findElement(By.id("lastName")).sendKeys("$Said");
		// Wait
		Thread.sleep(1000);
